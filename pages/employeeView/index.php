...
if(isset($_SESSION['userType'])){
  ...
  include 'viewEmployee-v'.$_SESSION['userType'].'.php';
  ...
  function viewProfile(id){
    window.open('../employeeDetail/?empID='+id,'_self');
  }

  function editProfile(id){
    window.open('editEmployee.php?empID='+id,'_self');
  }

  function deleteProfile(userType, id){

    var alertText = "";
    var deleteUrl = "";
    deleteUrl = "../../assets/php/employeeRemove.php";
    alertText = "The employee would be removed from the database!"
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if ( response.trim() == "success" ){
              ...
              table.row( $('.datatable-user-'+id)).remove().draw();
            }else {
              $('.loader').fadeOut();
