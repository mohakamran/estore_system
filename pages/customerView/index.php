...
if(isset($_SESSION['userType'])){
  ...
  include 'viewCustomer-v'.$_SESSION['userType'].'.php';
  ...
  function editProfile(id){
    window.open('editCustomer.php?customerID='+id,'_self');
  }
  ...
  function deleteProfile(id){
    ...
    var alertText = "";
    var deleteUrl = "";
    deleteUrl = "../../assets/php/customerRemove.php";
    alertText = "The customer would be removed from the database!"
