...
var invoiceTimestamp = '<?php echo time(); ?>';
var folderName = 'Invoice-' + invoiceTimestamp;

$(document).ready(function() {
    $("#endDateContainer").fadeOut();

    $("#attachmentsCard").click();
    ...
    $("#invoiceNumber").val('<?php echo time(); ?>');
    updateOrderTotal();
    getProducts();

    initFiler('attachments');
});
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (response.trim() == "success") {
                $('.loader').fadeOut();
                swal("Success!", "Invoice Generated!", "success")
                    .then((value) => {
                        location.reload();
                    });
            } else {
