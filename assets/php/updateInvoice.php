...
if ($_SESSION['username'] != '') {
  ...
  if ($_SESSION["userType"] == "0") {
    if ($customerID != '') {
      if($recurring == 1){
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', endDate='$endDate',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerID='$customerID', customerName='$customerName',	customerMobile='$customerMobile', customerEmail='$customerEmail',
        productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }else{
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerID='$customerID', customerName='$customerName',	customerMobile='$customerMobile', customerEmail='$customerEmail',
        productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }
    } else {
      if($recurring == 1){
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', endDate='$endDate',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerName='$customerName',	customerMobile='$customerMobile', customerEmail='$customerEmail',
        productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";

      }else{
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerName='$customerName',	customerMobile='$customerMobile', customerEmail='$customerEmail',
        productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }
    }
  } else {
    if ($customerID != '') {
      if($recurring == 1){
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', endDate='$endDate',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerID='$customerID', customerName='$customerName', productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }else{
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerID='$customerID', customerName='$customerName', productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }
    } else {
      if($recurring == 1){
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', endDate='$endDate',	invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerName='$customerName', productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }else{
        $sql = "UPDATE invoice SET referenceNumber='$referenceNumber', recurring='$recurring', invoiceDate='$invoiceDate',	paymentDate='$paymentDate',	company='$company', customerName='$customerName', productID='$productID', productCostPrice='$productCostPrice', productSellingPrice='$productSellingPrice', productQuantity='$productQuantity', orderTotal='$orderTotal', paymentTotal='$paymentTotal', paymentAmount='$paymentAmount', paymentType='$paymentType', paidDate = '$paidDate', status='$status', attachments='$attachments', notes='$notes' WHERE invoiceID = '$invoiceID'";
      }
    }
  }
