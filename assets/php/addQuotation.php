...
if ($_SESSION['username'] != '') {
  ...
  if ($customerID != '') {
    $sql = "INSERT INTO quotation (quotationID, referenceNumber,	quotationDate,	company, employeeID, customerID, customerName,	customerMobile, customerEmail, quotationItems, costPrice, sellingPrice)
    VALUES ('$quotationNumber', '$referenceNumber', '$quotationDate', '$company', '$employeeID', '$customerID',
      '$customerName', '$customerMobile', '$customerEmail', '$quotationItems', '$quotationCostPrice', '$quotationSellingPrice')";
  } else {
    $sql = "INSERT INTO quotation (quotationID, referenceNumber,	quotationDate,	company, employeeID, customerName,	customerMobile, customerEmail, quotationItems, costPrice, sellingPrice)
      VALUES ('$quotationNumber', '$referenceNumber', '$quotationDate', '$company', '$employeeID',
        '$customerName', '$customerMobile', '$customerEmail', '$quotationItems', '$quotationCostPrice', '$quotationSellingPrice')";
  }
    ...
    if (!empty($quotationItems)) {
      ...
      for ($index = 0; $index < sizeof($items); $index++) {
        $output .= '
            ...
            <td>' . $items[$index]->itemDuration . '</td>
            </tr>';
      }
